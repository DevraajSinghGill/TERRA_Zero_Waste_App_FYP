...
class AdminVoucherRedemptionPage extends StatefulWidget {
  const AdminVoucherRedemptionPage({super.key});

  @override
  _AdminVoucherRedemptionPageState createState() => _AdminVoucherRedemptionPageState();
}

class _AdminVoucherRedemptionPageState extends State<AdminVoucherRedemptionPage> {
  String selectedStatus = 'pending';

  Future<void> _approveRedemption(String redemptionId, int points, String userId) async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('redeemVoucherRequests').doc(redemptionId).update({
        'status': 'approved',
  ...
  void _showConfirmationDialog(String redemptionId, String userId, int points, String action) {
    showDialog(
      context: context,
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (action == 'approve') {
                        _approveRedemption(redemptionId, points, userId);
                      } else {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Review and Approve Redemptions',
                        style: AppTextStyles.nunitoBold.copyWith(color: Colors.white, fontSize: 14.sp),
                      ),
                      SizedBox(height: 15), // Reduce height between text
                      Text(
                        'As an admin, you can review the redemption requests submitted by users and approve or reject them. Each redemption contains details and points that the user can redeem upon approval.',
            ...
            StreamBuilder(
              stream: FirebaseFirestore.instance.collection('redeemVoucherRequests').where('status', isEqualTo: selectedStatus).snapshots(),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: AppTextStyles.nunitoRegular.copyWith(fontSize: 18.sp),
                        ),
                      ],
                    ),
                  );
                                  ...
                                  children: [
                                    ...
                                    if (selectedStatus == 'pending') // Conditionally render the buttons
                                      Row(
                                        ...
                                        children: [
                                          ElevatedButton(
                                            onPressed: () => _showConfirmationDialog(redemption.id, uid, data['points'], 'approve'),
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: Colors.green,
                                              shape: RoundedRectangleBorder(
                                                borderRadius: BorderRadius.circular(10.0),
                                          ...
                                          SizedBox(width: 20),
                                          ElevatedButton(
                                            onPressed: () => _showConfirmationDialog(redemption.id, uid, data['points'], 'reject'),
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: Colors.red,
                                              shape: RoundedRectangleBorder(
                                                borderRadius: BorderRadius.circular(10.0),
