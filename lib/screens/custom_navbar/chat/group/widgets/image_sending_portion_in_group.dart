...
class ImageSendingPortionInGroup extends StatelessWidget {
  final ImageController imageController;
  final Function() onSendBtnClick;
  final bool isLoading;
  const ImageSendingPortionInGroup(
      {super.key, required this.imageController, required this.onSendBtnClick, required this.isLoading});
